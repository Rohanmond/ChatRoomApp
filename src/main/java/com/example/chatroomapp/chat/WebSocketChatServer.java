package com.example.chatroomapp.chat;

import com.example.chatroomapp.chat.Config.MessageDecoder;
import com.example.chatroomapp.chat.Config.MessageEncoder;
...
public class WebSocketChatServer {
    ...
    private static void sendMessageToAll(Message msg) {
        sendMessageToAll(msg.getMsg(),msg.getMessageType(),msg.getUsername());
    }
